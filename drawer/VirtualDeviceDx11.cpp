...
VirtualDeviceDx11::VirtualDeviceDx11(const VirtualDeviceDx11& other)
{
}
...
bool VirtualDeviceDx11::CreateDepthStencilView(int width, int height)
{
	HRESULT result;
	D3D11_TEXTURE2D_DESC depthBufferDesc;
	D3D11_DEPTH_STENCIL_DESC depthStencilDesc;
...
void VirtualDeviceDx11::Shutdown()
{
...
void VirtualDeviceDx11::BeginScene(float red, float green, float blue, float alpha)
{
    float color[4];
...
void VirtualDeviceDx11::EndScene()
{
...
ID3D11Device* VirtualDeviceDx11::GetDevice()
{
    return m_device;
}


ID3D11DeviceContext* VirtualDeviceDx11::GetDeviceContext()
{
    return m_deviceContext;
}


void VirtualDeviceDx11::GetVideoCardInfo(char* cardName, int& memory)
{
...
void VirtualDeviceDx11::GetProjectionMatrix(D3DXMATRIX& projectionMatrix)
{
...
void VirtualDeviceDx11::GetWorldMatrix(D3DXMATRIX& worldMatrix)
{
...
void VirtualDeviceDx11::GetOrthoMatrix(D3DXMATRIX& orthoMatrix)
{
	orthoMatrix = m_orthoMatrix;
	return;
}

void VirtualDeviceDx11::TurnZBufferOn()
{
	m_deviceContext->OMSetDepthStencilState(m_depthStencilState, 1);
	return;
}
...
void VirtualDeviceDx11::TurnZBufferOff()
{
	m_deviceContext->OMSetDepthStencilState(m_depthDisabledStencilState, 1);
	return;
}

void VirtualDeviceDx11::SetScale(float k)
{
	mScale = k; 
}
